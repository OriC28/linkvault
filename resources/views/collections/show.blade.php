    ...
    <div x-data class="p-6 lg:p-8 flex-1 max-w-6xl mx-auto w-full">
        ...
        <div class="space-y-3 mb-8">
            @forelse ($bookmarks as $bookmark)
                <div
                    class ="bg-white/80 backdrop-blur-xl rounded-2xl py-4 px-6 border border-gray-200/60 shadow-sm
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        @else
                            <div
                                class="w-10 h-10 rounded-full bg-red-100 flex items-center justify-center text-xs
                                font-bold text-red-600 shrink-0">
                                <span>{{ $bookmark->present()->initialsURLName() }}</span>
                            </div>
                        @endif
                        <div>
                            <div class="flex items-center gap-2 mb-1 flex-1 min-w-0">
